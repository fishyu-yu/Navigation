...
function showHelp() {
  ...
  console.log('  DB_PASS        数据库密码')
  console.log('  DB_NAME        数据库名称 (默认: navigation)')
...
async function configureDatabaseWizard() {
  ...
  console.log('请配置PostgreSQL数据库连接信息：\n')
...
function generateConfigFile() {
  ...
  const envContent = `# Navigation System 配置文件
...
function configureSilentMode() {
  ...
  const requiredFields = [
    { key: 'database.username', name: '数据库用户名', env: 'DB_USER' },
    { key: 'database.password', name: '数据库密码', env: 'DB_PASS' },
